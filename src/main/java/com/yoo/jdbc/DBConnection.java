...
public class DBConnection {
	...
	public Connection getConn(String connUrl) {
		...
		try {
			...
			System.out.println("找不到驱动程序类型！");
			e.printStackTrace();
		} catch (SQLException e) {
			System.out.println("connection database error: =="+connUrl+"== at "+new java.util.Date());
			//e.printStackTrace();
		}
...
//		String[] resultArr = dbconn.getShowCreateTable("mysql://localhost:3306/tbc?user=root&password=yuanyuan", "h_action_comment");
